...
Let us say that `disco_facial_matching/__init__.py` has functions called `hello` and `world` imported
into it, and both have docstrings. To automatically generate docstring documentation,
create a ReST file, and add the following line to reference the `disco_facial_matching` module:

```rest
.. currentmodule:: disco_facial_matching
```
...
Let us say that `disco_facial_matching/__init__.py` has functions called `hello` and `world` imported
into it, and both have docstrings. To automatically generate docstring documentation,
create a Markdown file, and add the following line to reference the `disco_facial_matching` module:
