# Code of conduct for `disco_facial_matching`

Contributors to this repository hosted by `DVSA` are expected to follow the
...
- "Project", we mean this `disco_facial_matching` GitHub repository;
- "Maintainer", we mean the `DVSA` organisation owners; and
- "Leadership", we mean both `DVSA` organisation owners, line managers, and other
  leadership within the DVSA.
...
[david.james@dvsa.gov.uk][email-address]. All complaints will be
...
[email-address]: mailto:david.james@dvsa.gov.uk
